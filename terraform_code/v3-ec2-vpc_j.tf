...
resource "aws_route_table_association" "dev-rta-public-subnet-01" {
  subnet_id = aws_subnet.dev-public-subnet-01.id
  route_table_id = aws_route_table.dev-public-rt.id   
}

resource "aws_route_table_association" "dev-rta-public-subnet-02" {
